# Workshop: Organisere og gjennomføre en analyse
...
Når vi bruker Jamovi kan det være lurt å re-organisere dataene sånn at hver "sub-analyse", eller hvert gruppe av analyser får en egen `omv`-fil. Nå får vi også mulighet til å kontrollere variabler og sette opp data for testen som vi tenker skal besvare spørsmålene i prosjektet. 
...
- Før vi kan analysere utfallet i studien bør vi bestemme hva vi skal analysere. Hva er utfallet? Dette er ikke alltid helt klart fra en løst formulert problemstilling. Diskuter hva vi ønsker å måle effekten av intervensjonen i.

- Når man har bestemt *hva* og *hvordan* man ønsker å analysere bør dette føres inn i *README*-file. For eksempel:
