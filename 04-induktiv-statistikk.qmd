...
df <- data.frame(n10 = rep(NA, 10), n20 = rep(NA, 10), n40 = rep(NA, 10), n80 = rep(NA, 10)) 

for(i in 1:10) {
  
  df[i,1] <- pwr.t.test(d = i/10, sig.level = 0.05, n = 10, type = "two.sample")$power
  df[i,2] <- pwr.t.test(d = i/10, sig.level = 0.05, n = 20, type = "two.sample")$power
  df[i,3] <- pwr.t.test(d = i/10, sig.level = 0.05, n = 40, type = "two.sample")$power
  df[i,4] <- pwr.t.test(d = i/10, sig.level = 0.05, n = 80, type = "two.sample")$power
...
df %>%
  ...
  ggplot(aes(x = es, y = value, color = factor(name))) +
