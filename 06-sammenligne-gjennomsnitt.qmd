...
Dessverre finner vi at det finnes flere måter å lage dette estimatet på, det er heller ikke sikkert at vi er enige om hva det er vi ønsker å estimere for å på best måte fange fenomenet vi ønsker å undersøke. Vi kan skille på tre begreper (se @fig-estimand), et estimat er den kvantitet som vi ønsker å få fra vår statistiske analyse. En estimator er måten vi beregner denne kvantiteten på og en estimand er det vi ønsker å estimere.
